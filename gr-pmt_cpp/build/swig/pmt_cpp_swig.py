...
class set_ccc_master(object):
    ...
    def make():
        """
        make() -> set_ccc_master_sptr

        Return a shared_ptr to a new instance of pmt_cpp::set_ccc_master.
        ...
        Params: (NONE)
        """
        return _pmt_cpp_swig.set_ccc_master_make()

    make = staticmethod(make)
    __swig_destroy__ = _pmt_cpp_swig.delete_set_ccc_master
    __del__ = lambda self : None;
set_ccc_master_swigregister = _pmt_cpp_swig.set_ccc_master_swigregister
set_ccc_master_swigregister(set_ccc_master)

def set_ccc_master_make():
  """
    set_ccc_master_make() -> set_ccc_master_sptr
...
class set_ccc_master_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::pmt_cpp::set_ccc_master)> class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(boost::shared_ptr<(gr::pmt_cpp::set_ccc_master)> self) -> set_ccc_master_sptr
        __init__(boost::shared_ptr<(gr::pmt_cpp::set_ccc_master)> self, set_ccc_master p) -> set_ccc_master_sptr
        """
        this = _pmt_cpp_swig.new_set_ccc_master_sptr(*args)
        try: self.this.append(this)
        except: self.this = this
    def __deref__(self):
        """__deref__(set_ccc_master_sptr self) -> set_ccc_master"""
        return _pmt_cpp_swig.set_ccc_master_sptr___deref__(self)

    __swig_destroy__ = _pmt_cpp_swig.delete_set_ccc_master_sptr
    __del__ = lambda self : None;
    def make(self):
        """
        make(set_ccc_master_sptr self) -> set_ccc_master_sptr
        ...
        Params: (NONE)
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_make(self)

    def history(self):
        """history(set_ccc_master_sptr self) -> unsigned int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_history(self)

    def declare_sample_delay(self, *args):
        """
        declare_sample_delay(set_ccc_master_sptr self, int which, int delay)
        declare_sample_delay(set_ccc_master_sptr self, unsigned int delay)
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_declare_sample_delay(self, *args)

    def sample_delay(self, *args, **kwargs):
        """sample_delay(set_ccc_master_sptr self, int which) -> unsigned int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_sample_delay(self, *args, **kwargs)

    def output_multiple(self):
        """output_multiple(set_ccc_master_sptr self) -> int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_output_multiple(self)

    def relative_rate(self):
        """relative_rate(set_ccc_master_sptr self) -> double"""
        return _pmt_cpp_swig.set_ccc_master_sptr_relative_rate(self)

    def start(self):
        """start(set_ccc_master_sptr self) -> bool"""
        return _pmt_cpp_swig.set_ccc_master_sptr_start(self)

    def stop(self):
        """stop(set_ccc_master_sptr self) -> bool"""
        return _pmt_cpp_swig.set_ccc_master_sptr_stop(self)

    def nitems_read(self, *args, **kwargs):
        """nitems_read(set_ccc_master_sptr self, unsigned int which_input) -> uint64_t"""
        return _pmt_cpp_swig.set_ccc_master_sptr_nitems_read(self, *args, **kwargs)

    def nitems_written(self, *args, **kwargs):
        """nitems_written(set_ccc_master_sptr self, unsigned int which_output) -> uint64_t"""
        return _pmt_cpp_swig.set_ccc_master_sptr_nitems_written(self, *args, **kwargs)

    def max_noutput_items(self):
        """max_noutput_items(set_ccc_master_sptr self) -> int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_max_noutput_items(self)

    def set_max_noutput_items(self, *args, **kwargs):
        """set_max_noutput_items(set_ccc_master_sptr self, int m)"""
        return _pmt_cpp_swig.set_ccc_master_sptr_set_max_noutput_items(self, *args, **kwargs)

    def unset_max_noutput_items(self):
        """unset_max_noutput_items(set_ccc_master_sptr self)"""
        return _pmt_cpp_swig.set_ccc_master_sptr_unset_max_noutput_items(self)

    def is_set_max_noutput_items(self):
        """is_set_max_noutput_items(set_ccc_master_sptr self) -> bool"""
        return _pmt_cpp_swig.set_ccc_master_sptr_is_set_max_noutput_items(self)

    def set_min_noutput_items(self, *args, **kwargs):
        """set_min_noutput_items(set_ccc_master_sptr self, int m)"""
        return _pmt_cpp_swig.set_ccc_master_sptr_set_min_noutput_items(self, *args, **kwargs)

    def min_noutput_items(self):
        """min_noutput_items(set_ccc_master_sptr self) -> int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_min_noutput_items(self)

    def max_output_buffer(self, *args, **kwargs):
        """max_output_buffer(set_ccc_master_sptr self, int i) -> long"""
        return _pmt_cpp_swig.set_ccc_master_sptr_max_output_buffer(self, *args, **kwargs)

    def set_max_output_buffer(self, *args):
        """
        set_max_output_buffer(set_ccc_master_sptr self, long max_output_buffer)
        set_max_output_buffer(set_ccc_master_sptr self, int port, long max_output_buffer)
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_set_max_output_buffer(self, *args)

    def min_output_buffer(self, *args, **kwargs):
        """min_output_buffer(set_ccc_master_sptr self, int i) -> long"""
        return _pmt_cpp_swig.set_ccc_master_sptr_min_output_buffer(self, *args, **kwargs)

    def set_min_output_buffer(self, *args):
        """
        set_min_output_buffer(set_ccc_master_sptr self, long min_output_buffer)
        set_min_output_buffer(set_ccc_master_sptr self, int port, long min_output_buffer)
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_set_min_output_buffer(self, *args)

    def pc_noutput_items(self):
        """pc_noutput_items(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_noutput_items(self)

    def pc_noutput_items_avg(self):
        """pc_noutput_items_avg(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_noutput_items_avg(self)

    def pc_noutput_items_var(self):
        """pc_noutput_items_var(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_noutput_items_var(self)

    def pc_nproduced(self):
        """pc_nproduced(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_nproduced(self)

    def pc_nproduced_avg(self):
        """pc_nproduced_avg(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_nproduced_avg(self)

    def pc_nproduced_var(self):
        """pc_nproduced_var(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_nproduced_var(self)

    def pc_input_buffers_full(self, *args):
        """
        pc_input_buffers_full(set_ccc_master_sptr self, int which) -> float
        pc_input_buffers_full(set_ccc_master_sptr self) -> pmt_vector_float
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_input_buffers_full(self, *args)

    def pc_input_buffers_full_avg(self, *args):
        """
        pc_input_buffers_full_avg(set_ccc_master_sptr self, int which) -> float
        pc_input_buffers_full_avg(set_ccc_master_sptr self) -> pmt_vector_float
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_input_buffers_full_avg(self, *args)

    def pc_input_buffers_full_var(self, *args):
        """
        pc_input_buffers_full_var(set_ccc_master_sptr self, int which) -> float
        pc_input_buffers_full_var(set_ccc_master_sptr self) -> pmt_vector_float
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_input_buffers_full_var(self, *args)

    def pc_output_buffers_full(self, *args):
        """
        pc_output_buffers_full(set_ccc_master_sptr self, int which) -> float
        pc_output_buffers_full(set_ccc_master_sptr self) -> pmt_vector_float
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_output_buffers_full(self, *args)

    def pc_output_buffers_full_avg(self, *args):
        """
        pc_output_buffers_full_avg(set_ccc_master_sptr self, int which) -> float
        pc_output_buffers_full_avg(set_ccc_master_sptr self) -> pmt_vector_float
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_output_buffers_full_avg(self, *args)

    def pc_output_buffers_full_var(self, *args):
        """
        pc_output_buffers_full_var(set_ccc_master_sptr self, int which) -> float
        pc_output_buffers_full_var(set_ccc_master_sptr self) -> pmt_vector_float
        """
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_output_buffers_full_var(self, *args)

    def pc_work_time(self):
        """pc_work_time(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_work_time(self)

    def pc_work_time_avg(self):
        """pc_work_time_avg(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_work_time_avg(self)

    def pc_work_time_var(self):
        """pc_work_time_var(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_work_time_var(self)

    def pc_work_time_total(self):
        """pc_work_time_total(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_work_time_total(self)

    def pc_throughput_avg(self):
        """pc_throughput_avg(set_ccc_master_sptr self) -> float"""
        return _pmt_cpp_swig.set_ccc_master_sptr_pc_throughput_avg(self)

    def set_processor_affinity(self, *args, **kwargs):
        """set_processor_affinity(set_ccc_master_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _pmt_cpp_swig.set_ccc_master_sptr_set_processor_affinity(self, *args, **kwargs)

    def unset_processor_affinity(self):
        """unset_processor_affinity(set_ccc_master_sptr self)"""
        return _pmt_cpp_swig.set_ccc_master_sptr_unset_processor_affinity(self)

    def processor_affinity(self):
        """processor_affinity(set_ccc_master_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _pmt_cpp_swig.set_ccc_master_sptr_processor_affinity(self)

    def active_thread_priority(self):
        """active_thread_priority(set_ccc_master_sptr self) -> int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_active_thread_priority(self)

    def thread_priority(self):
        """thread_priority(set_ccc_master_sptr self) -> int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_thread_priority(self)

    def set_thread_priority(self, *args, **kwargs):
        """set_thread_priority(set_ccc_master_sptr self, int priority) -> int"""
        return _pmt_cpp_swig.set_ccc_master_sptr_set_thread_priority(self, *args, **kwargs)

    def name(self):
        """name(set_ccc_master_sptr self) -> std::string"""
        return _pmt_cpp_swig.set_ccc_master_sptr_name(self)

    def symbol_name(self):
        """symbol_name(set_ccc_master_sptr self) -> std::string"""
        return _pmt_cpp_swig.set_ccc_master_sptr_symbol_name(self)

    def input_signature(self):
        """input_signature(set_ccc_master_sptr self) -> io_signature_sptr"""
        return _pmt_cpp_swig.set_ccc_master_sptr_input_signature(self)

    def output_signature(self):
        """output_signature(set_ccc_master_sptr self) -> io_signature_sptr"""
        return _pmt_cpp_swig.set_ccc_master_sptr_output_signature(self)

    def unique_id(self):
        """unique_id(set_ccc_master_sptr self) -> long"""
        return _pmt_cpp_swig.set_ccc_master_sptr_unique_id(self)

    def to_basic_block(self):
        """to_basic_block(set_ccc_master_sptr self) -> basic_block_sptr"""
        return _pmt_cpp_swig.set_ccc_master_sptr_to_basic_block(self)

    def check_topology(self, *args, **kwargs):
        """check_topology(set_ccc_master_sptr self, int ninputs, int noutputs) -> bool"""
        return _pmt_cpp_swig.set_ccc_master_sptr_check_topology(self, *args, **kwargs)

    def alias(self):
        """alias(set_ccc_master_sptr self) -> std::string"""
        return _pmt_cpp_swig.set_ccc_master_sptr_alias(self)

    def set_block_alias(self, *args, **kwargs):
        """set_block_alias(set_ccc_master_sptr self, std::string name)"""
        return _pmt_cpp_swig.set_ccc_master_sptr_set_block_alias(self, *args, **kwargs)

    def _post(self, *args, **kwargs):
        """_post(set_ccc_master_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _pmt_cpp_swig.set_ccc_master_sptr__post(self, *args, **kwargs)

    def message_ports_in(self):
        """message_ports_in(set_ccc_master_sptr self) -> swig_int_ptr"""
        return _pmt_cpp_swig.set_ccc_master_sptr_message_ports_in(self)

    def message_ports_out(self):
        """message_ports_out(set_ccc_master_sptr self) -> swig_int_ptr"""
        return _pmt_cpp_swig.set_ccc_master_sptr_message_ports_out(self)

    def message_subscribers(self, *args, **kwargs):
        """message_subscribers(set_ccc_master_sptr self, swig_int_ptr which_port) -> swig_int_ptr"""
        return _pmt_cpp_swig.set_ccc_master_sptr_message_subscribers(self, *args, **kwargs)

set_ccc_master_sptr_swigregister = _pmt_cpp_swig.set_ccc_master_sptr_swigregister
set_ccc_master_sptr_swigregister(set_ccc_master_sptr)

set_ccc_master_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
set_ccc_master = set_ccc_master.make;
