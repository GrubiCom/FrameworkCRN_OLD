...
%feature("docstring") gr::pmt_cpp::set_ccc_master "<+description of block+>"

%feature("docstring") gr::pmt_cpp::set_ccc_master::make "Return a shared_ptr to a new instance of pmt_cpp::set_ccc_master.

To avoid accidental use of raw pointers, pmt_cpp::set_ccc_master's constructor is in a private implementation class. pmt_cpp::set_ccc_master::make is the public interface for creating new instances.
